...
<div align="center">
  ...
  <br>
   ...
   <div id="CSS">
    <img align="left" height="290em" alt="Cleudeir-React"  src="https://raw.githubusercontent.com/devicons/devicon/master/icons/css3/css3-original.svg">
    <h2>CSS</h2>
    <h5>
      ✔️ Estrutura visual de uma página, com 'margin' e 'padding'<br/>
      ✔️ Estabelecer o tamanho com 'width' e 'height'<br/>
      ✔️ Posição de um elemento ('static', 'relative' ou 'absolute)<br/>
      ✔️ Display de exibição ('block', 'inline', 'inline-block')<br/>
      ✔️ Posicionar imagens em relação ao texto<br/>
      ✔️ Alinhamento, fontes<<br/>
      ✔️ Diferenças e vantagens de usar as diferentes unidades de medida em CSS (%, relativas, etc)<br/>
      ✔️ Conectar com os elementos (IDs, classes) de um arquivo HTML<br/>
      ✔️ Alterar características de um elemento quando o mouse passar por cima dele ('hover')<br/>
      ✔️ Box-sizing, Flexbox, Grid<br/>
       <br/>
       <br/>
    </h5>
  </div>
 ...
 <br>
  ...
  <br>
   ...
   <div id="Nextjs">
    ...
    <h2>Nextjs</h2>
    <h5>
      ✔️ Diminuir o tempo de carregamento das páginas</br>
      ✔️ Renderizar páginas no lado do servidor</br>
      ✔️ Melhorar a performance em React</br>
      ✔️ Construir rotas de API com funções serveless</br>
      ✔️ CSS-in-JS</br>
      ✔️ Getstaticprops and getstaticpaths</br>
      <br/>
      <br/>
      <br>
    </h5>
